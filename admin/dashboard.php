              ...
              <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1"><a href="daily.php">Uploaded Last 24 Hrs</a></div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800">
                          <?php
                          $date = date("Y-m-d");
                          $sql=$query = "select * from reports where  `date` >= DATE_SUB(CURDATE(),INTERVAL 24 HOUR )";
